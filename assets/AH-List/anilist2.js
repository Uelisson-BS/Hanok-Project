...
const INDEX_URL=BASE_URL+'/Hanok-Project/assets/AH-List/db2-list.json'
const INDEX_URL2=BASE_URL+'/Hanok-Project/assets/AH-List/Post2-id/'
const POSTER_URL=''
const data=[]
